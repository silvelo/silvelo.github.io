...
gulp.task("css", () => {
  return gulp
    ...
    .pipe(
       ...
       */
      purify(["../dist/silvelo/*.js"], {
        info: true,
        minify: true,
        rejected: true,
        whitelist: ["fa-twitter:before", "fa-linkedin:before", "fa-github:before", "fa-envelope:before", "fa-npm:before"]
      })
    )
...
gulp.task("copy-op-css", () => {
  return gulp.src("../dist/test/*").pipe(gulp.dest("../dist/silvelo"));
});
// #6 | Clear temp folder
